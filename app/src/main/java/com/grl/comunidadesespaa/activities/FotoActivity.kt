...
import com.grl.comunidadesespaa.databinding.ActivityFotoBinding
...
class FotoActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Log.e(TAG, "Vinculación erronea", ex)
            }
    ...
    private fun takePhoto() {
        ...
        val name = "${comunidad}_" + SimpleDateFormat(FILENAME_FORMAT, Locale.US)
    ...
    companion object {
        private const val TAG = "ComunidadesEspaña"
